        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_BoxId = table.Column<int>(type: "int", nullable: false),
                    fk_ItemTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Items", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Items_Boxes_fk_BoxId",
                        column: x => x.fk_BoxId,
                        principalTable: "Boxes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Items_ItemTypes_fk_ItemTypeId",
                        column: x => x.fk_ItemTypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_fk_BoxId",
                table: "Items",
                column: "fk_BoxId");

            migrationBuilder.CreateIndex(
                name: "IX_Items_fk_ItemTypeId",
                table: "Items",
                column: "fk_ItemTypeId");
        }
